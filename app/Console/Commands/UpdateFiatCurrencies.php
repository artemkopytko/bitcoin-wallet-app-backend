...
class UpdateFiatCurrencies extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:update-fiat-currencies';
    ...
    public function handle()
    {
        ...
        $assets = Currency::where(function ($query) {
                $query->where('updated_at', '<', now()->subMinutes(60))
                    ->orWhereNull('updated_at');
            })
            ->where('type', CurrencyTypes::FIAT)
